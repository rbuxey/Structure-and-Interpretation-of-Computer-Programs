...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
            for b in fire_tomb:
                Insect.reduce_armor(b, amount+self.damage)
        else:
            for b in fire_tomb:
                Insect.reduce_armor(b, amount)
    ...
    def action(self, gamestate):
        ...
        if self.digesting == 0:
            if len(self.place.bees) > 0:
                return self.eat_bee(rANTdom_else_none(self.place.bees))
            else:
                return None
        else:
            self.digesting -= 1
...
# BEGIN Problem 8
class WallAnt(Ant):
    """WallAnt adds some protection to the homebase"""
    ...
    def __init__(self, armor=4):
        return Ant.__init__(self, armor)
# END Problem 8
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        if not isinstance(other, ContainerAnt) or other.contained_ant == None:
            return True
        else:
            return False
        # END Problem 9
    ...
    def remove_from(self, place):
        ...
        if place.self is self:
            # Container was removed. Contained ant should remain in the game
            place.self = place.self.contained_ant
            Insect.remove_from(self, place)
        else:
    ...
    def action(self, gamestate):
        # BEGIN Problem 9
        if self.contain_ant(self) is not None:
            return Ant.action(self, gamestate)
        # END Problem 9
...
class BodyguardAnt(ContainerAnt):
    ...
    def __init__(self,armor=2):
        return ContainerAnt.__init__(self, armor)
    # END Problem 9
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        if QueenAnt.one_true_queen == True:
            self.one_true_queen = False
        else:
            QueenAnt.one_true_queen = True
        # END Problem 13
    ...
    def action(self, gamestate):
        ...
        def double_the_damage(self, ant):
            if ant not in ant_lst and ant != isinstance(ant, QueenAnt):
                ant.damage *= 2
                ant_lst.append(ant)
            if isinstance(ant, BodyguardAnt) and ant.ant not in ant_lst:
                ant.ant.damage *= 2
                ant_lst.append(ant.ant)
        ...
        if self.one_true_queen:
            ...
            while current_place.exit is not None:
                if current_ant is not None:
                    double_the_damage(self, current_ant)
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        self.armor -= amount
        if self.armor <=0 and self.one_true_queen:
            bees_win()
        # END Problem 13
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN Problem EC
        target_lst = []
        if target and target not in target_lst:
